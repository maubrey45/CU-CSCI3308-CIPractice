...
START_TEST(test_2d_area_triangle)
{
    ...
    //testing if all points are at (0,0), you get a 0 area
    a.x = 0.0;
    a.y = 0.0;
    b.x = 0.0;
    b.y = 0.0;
    ...
    c.y = 0.0;
    expArea = 0.0;
    testArea = coord_2d_area_triangle(&a, &b,&c);
    //coord_2d_dist(&a, &b) == 0.0
    ck_assert(testArea == expArea);

    //testing if two points are at (0,0), one is at (2,2), and get zero
    a.x = 0.0;
    a.y = 0.0;
    b.x = 0.0;
    b.y = 0.0;
    ...
    //testing if one point is at (0,0), the rest at none (0,0) you get number
    //(0,0), (1,2), (1,5)
    //first establish 
    a.x = 1.0;
    a.y = 2.0;
    ...
    //testing if all points are at (23,30)(15,15)(42,8), you get 230.5
    a.x = 23.0;
    a.y = 30.0;
    b.x = 15.0;
    b.y = 15.0;
